...
hws = [
    ...
    HW_DATA("4090", 48 * 1024 ** 3, 660e12, 1000e9, 32e9, 8, 32e9, 150000, 28382), 
    HW_DATA("5090", 96 * 1024 ** 3, 840e12, 1800e9, 64e9, 8, 50e9, 150000, 28382), 
    HW_DATA("GB200", 192 * 1024 ** 3, 5000e12, 8000e9, 900e9, 8, 900e9, 1000000, 28382), 
    HW_DATA("H20", 96 * 1024 ** 3, 296e12, 4000e9, 450e9, 8, 50e9, 150000, 20813), 
    HW_DATA("H20-141GB", 141 * 1024 ** 3, 296e12, 4000e9, 450e9, 8, 50e9, 150000, 20813), 
    ...
    HW_DATA("910B", 64 * 1024 ** 3, 750e12, 1600e9, 196e9, 8, 50e9, 200000 // 2, 39420 // 2),
